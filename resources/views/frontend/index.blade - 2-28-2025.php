...
<div class="bow">
  ...
  <path d="M1030.014,96.91  C874.836,250.578,646.766,344.637,427.042,357.866H100.749C49.358,358.572,2.898,402.262,0,459.889V607.02  c0.701,51.369,43.068,99.121,100.699,102.021h130.821c-34.962,118.567,2.593,238.596,43.15,356.415  c60.166,56.81,197.785,49.742,242.638-24.195c-95.523-75.091-142.05-277.145-26.889-326.979  c196.285,22.271,390.749,122.01,539.594,255.716c51.169-0.701,97.705-42.745,100.699-100.062V628.618  c102.449-36.383,81.738-164.259,0-190.28V197.659c-0.683-51.365-43.073-97.799-100.699-100.7V96.91z M1032.609,227.045v613.453  C888.778,728.424,711.072,653.216,527.741,619.46V448.134C707.635,421.062,883.576,338.057,1032.609,227.045z"></path>
      ...
      <h2><a href="http://127.0.0.1:8000/view-category/html" class="text-secondary"> {{$blogitem->name}}</a></h2>
...
<section class="ts-wrapper" id="contact">
    <div class="grew"><h2 class="title">Contact us</h2></div>
    <div class="secIn">
    <div class="bow">
...
<p class='p-corn'>Read our FAQ's to understand the details of services we're providing to help you improve your website</p>
<div class='bow'>
<div class='freq-nap section' id='Freq-accordion-1'><div class='widget HTML' data-version='2' id='HTML56'>
<div class='widget-content wow fadeInUp' data-wow-delay='0s'>
<div class='accordion'>
      <div class='accordion__title'>Is BizTratus reliable?</div>
      <div class='accordion__inner'>
        <div class='accordion__content'>
          <p>Some content. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas, mollitia? Porro quod officia in non et aperiam ipsa ab sit nihil necessitatibus corrupti explicabo quam sapiente est culpa nostrum, nisi, optio dicta cumque eum cum a repudiandae. Aperiam, qui aliquid.</p>
        </div>
      </div>
    </div>
<div class='accordion'>
      <div class='accordion__title'>How to buy this Template?</div>
      <div class='accordion__inner'>
        <div class='accordion__content'>
          <p>Some content. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas, mollitia? Porro quod officia in non et aperiam ipsa ab sit nihil necessitatibus corrupti explicabo quam sapiente est culpa nostrum, nisi, optio dicta cumque eum cum a repudiandae. Aperiam, qui aliquid.</p>
        </div>
...
<div class='accordion'>
      <div class='accordion__title'>Accordion title 3</div>
      <div class='accordion__inner'>
        <div class='accordion__content'>
          <p>Some content. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas, mollitia? Porro quod officia in non et aperiam ipsa ab sit nihil necessitatibus corrupti explicabo quam sapiente est culpa nostrum, nisi, optio dicta cumque eum cum a repudiandae. Aperiam, qui aliquid.</p>
        </div>
...
<div class='freq-nap section' id='Freq-accordion-2'><div class='widget HTML' data-version='2' id='HTML76'>
<div class='widget-content wow fadeInUp' data-wow-delay='0.3s'>
<div class='accordion'>
      <div class='accordion__title'>Can i ask for discount?</div>
      <div class='accordion__inner'>
        <div class='accordion__content'>
          <p>Some content. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas, mollitia? Porro quod officia in non et aperiam ipsa ab sit nihil necessitatibus corrupti explicabo quam sapiente est culpa nostrum, nisi, optio dicta cumque eum cum a repudiandae. Aperiam, qui aliquid.</p>
        </div>
...
<div class='accordion'>
      <div class='accordion__title'>Will I get premium support?</div>
      <div class='accordion__inner'>
        <div class='accordion__content'>
          <p>Some content. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas, mollitia? Porro quod officia in non et aperiam ipsa ab sit nihil necessitatibus corrupti explicabo quam sapiente est culpa nostrum, nisi, optio dicta cumque eum cum a repudiandae. Aperiam, qui aliquid.</p>
        </div>
