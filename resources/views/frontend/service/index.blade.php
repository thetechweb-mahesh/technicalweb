...
<div class='grew'><h2>  {{ $category->name }}
...
<div class='ts-left wow fadeInLeft section' ><div class='widget HTML' data-version='2' id='HTML41'>
<div class='widget-content'>
<div class="" >
<img class="lazy loaded"  src="{{asset('uploads/service/'.$service_cate->image)}}" alt="image" /></div>
</div>
</div></div>
<div class='ts-right yape wow fadeInRight section' id='company-detail'><div class='widget HTML' data-version='2' id='HTML97'>
<h3 class='title'>
    <a href="{{url('category/'.$service_cate->slug)}}" class="text-secondary">{{ $service_cate->name }}</a>
</h3>
<div class='widget-content'>
...
{{ $service_cate->m_ser_title }}
</h2>
<div class='widget-content'>
<p>{{ $service_cate->m_ser_des }}</p>
</div>
</div></div>
...
<h4>
    {{ $service_cate->ser_list_title }}</h4>
<p> {{ $service_cate->ser_list_des }}</p>
</div>
</div>
