                ...
                <div class="example">
                  ...
                  <div class="tab-content rounded-bottom">
                    <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
                        <form class="forms-sample" action="{{url('admin/add-service')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="m_ser_title" placeholder="mission title">
                            <label class="form-label" for="exampleFormControlTextarea1">description</label>
                            <textarea class="form-control" name="m_ser_des" id="" rows="3"></textarea>
                          </div>

                          <div class="mb-3">

                            <label class="form-label" for="exampleFormControlInput1">mission list</label>
                            <input class="form-control" type="text" name="ser_list_title" placeholder="mission list_title">
                            <label class="form-label" for="exampleFormControlTextarea1">description</label>
                            <textarea class="form-control" name="ser_list_des" id="" rows="3"></textarea>
                          </div>
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" name="meta_description" id="summernote" rows="3"></textarea>
                      </div>
