                ...
                <div class="example">
                  ...
                  <div class="tab-content rounded-bottom">
                    <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
                        <form class="forms-sample" action="{{url('admin/add-about')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="discripsion" id="discripsion" rows="3"></textarea>
                          </div>
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" name="meta_discripsion" id="discripsion" rows="3"></textarea>
                      </div>
{{-- 
                      <div class="mb-3">
