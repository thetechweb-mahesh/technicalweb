                ...
                <div class="example">
                  ...
                  <div class="tab-content rounded-bottom">
                    <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
                        <form class="forms-sample" action="{{url('admin/update-post/'.$post->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="name" value="{{$post->name}}" placeholder="First Name">
                          </div>
                        <div class="mb-3">
                            <label class="form-label" for="exampleFormControlInput1">slug</label>
                            <input class="form-control" type="text"name="slug" value="{{$post->slug}}" placeholder="Your slug">
                          </div>
                        <div class="mb-3">
                            <label class="form-label" for="exampleFormControlTextarea1">description</label>
                            <textarea class="form-control" name="description" id="mysummernote" rows="3">{{$post->description}}</textarea>
                          </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="yt_ifranme" value="{{$post->yt_ifranme}}" placeholder="yt_ifranme">
                          </div>
                      ...
                      <div class="mb-3">
                        ...
                        <textarea class="form-control" name="meta_description" id="mysummernote" rows="3">{{$post->meta_description}}</textarea>
                      </div>

                      <div class="mb-3">
                        <label class="form-label" for="exampleFormControlTextarea1">Meta Keyword</label>

                      <textarea class="form-control" name="meta_keyword" rows="2"  placeholder="Meta Keyword">{{$post->meta_keyword}}</textarea>
                      </div>
                      <div class="form-group">
